...
- **Active Project Directory**: `C:\Users\napht\Documents\GarbyMostLatest\Test`
- **Authoritative Hardware Status**: `ESP32 Dev Module selected in GUI (No microcontroller connected on COM port).`
- **Currently Selected Board**: `ESP32 Dev Module`
- **Target Platform / Architecture**: `espressif32` (esp32dev)
- **Connected COM Port**: `None (No microcontroller connected)`
- **Serial Monitor Baud Rate**: `115200`
- **Upload Speed**: `460800` bps
- **Main Sketch Files in Project Root**: `Test.ino`
...
- Backup root: `C:/Users/napht/Documents/GarbyMostLatest/Test/.mcu_flasher_build_cache/.mcu_ai_edits`
