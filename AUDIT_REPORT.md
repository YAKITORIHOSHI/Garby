...
**Audit/rework date:** 2026-08-21; nudge/safety follow-up: 2026-08-23  
...
The 2026-08-23 follow-up rechecked the active root copies, synchronized the
agent/reference documentation, removed unused legacy MCU tuning constants,
added side-object collision handling to the simulator, and updated validation
evidence for the centered nudge and Servo+Ultrasonic interlock changes.
