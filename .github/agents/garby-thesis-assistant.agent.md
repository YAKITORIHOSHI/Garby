...
# GARBY Thesis Assistant — 2026-08-23 Follow-up Baseline
...
- Nudge dead zone/hysteresis: 18/12 cm
- Nudge confirmation/cooldown: 5 packets / 1200 ms
- Bridge tap: 35–60 ms, 8–18% requested cut
- Side object handling: ≤40 cm redirects away; ≤22 cm blocks both travel directions
- Centered Servo+Ultrasonic: a fresh ≤60 cm echo stops before nudge execution
